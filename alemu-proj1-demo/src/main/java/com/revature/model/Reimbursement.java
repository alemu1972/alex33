...
public class Reimbursement {
	...
	public Reimbursement(int reimbId, int reimbAmount, String reimbSubmitted, String reimbResolved, String reimbStatus,
			String reimbType, String reimbDescription, int reimbAuthor, int reimbResolver) {
		super();
	...
	@Override
	public int hashCode() {
		return Objects.hash(reimbAmount, reimbAuthor, reimbDescription, reimbId, reimbResolved,
